...
export const LAUNCH_ERRORS: Record<string, string> = {
  ...
  curve_missing: "Solana is still landing the pool. Wait, then check Your tokens. Do not launch again.",
  ...
  graduated: "This coin hit the 85 SOL milestone. It still trades on the Solphia curve.",
  not_on_curve: "Not on the Solphia curve. We only swap tokens launched on our program.",
  desk_mint: "Use the live desk for SOL / USDC / official xStocks.",
