...
export const LAUNCH_ERRORS: Record<string, string> = {
  ...
  mint_missing: "The mint is not on-chain yet. Sign both Phantom prompts.",
  mint_empty: "The mint has no supply. Sign the second Phantom prompt.",
  mint_not_locked: "Mint or freeze is still open. Sign the lock prompt in Phantom.",
